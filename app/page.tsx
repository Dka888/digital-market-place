...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: 'Every assets on your platform is verified by our team.'
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
    description: 'We are pledged 1% of sales to the preservation and restoration of the natural environment.'
  }
]
...
export default function Home() {
  return (
   ...
   <MaxWidthWrapper>
    ...
    <ProductReel title="Brand new" href="/products" query={{sort: "asc"}}/>
   </MaxWidthWrapper>
