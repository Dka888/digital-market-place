...
var yourOwnPurchased = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFilesIds, orders, purchasedProductFileIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFilesIds, true), purchasedProductFileIds, true),
                            },
                        }];
            }
        });
...
exports.ProductFiles = {
    ...
    access: {
        read: function (_a) {
            var req = _a.req;
            return yourOwnPurchased({ req: req });
        },
        update: function (_a) {
            var req = _a.req;
